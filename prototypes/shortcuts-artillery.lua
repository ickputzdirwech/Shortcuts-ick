	...
	data:extend({
		{
			...
			action = "lua",
			technology_to_unlock = "artillery-bombardment-remote",
			unavailable_until_unlocked = true,
		...
		},
		{
			...
			action = "lua",
			technology_to_unlock = "smart-artillery-bombardment-remote",
			unavailable_until_unlocked = true,
		...
		},
		{
			...
			action = "lua",
			technology_to_unlock = "smart-artillery-exploration-remote",
			unavailable_until_unlocked = true,
...
if mods["MIRV"] and data.raw.capsule["mirv-targeting-remote"] and settings.startup["mirv-targeting-remote"].value then
	data:extend({{
		...
		action = "lua",
		technology_to_unlock = "mirv-technology",
		unavailable_until_unlocked = true,
		style = "red",
...
if mods["AtomicArtilleryRemote"] and settings.startup["atomic-artillery-targeting-remote"].value then
	data:extend({{
		...
		action = "lua",
		technology_to_unlock = "atomic-artillery",
		unavailable_until_unlocked = true,
		style = "red",
		icon = "__Shortcuts-ick__/graphics/mirv-targeting-remote-x32-white.png",
		icon_size = 32,
...
if mods["landmine-thrower"] and data.raw.capsule["landmine-thrower-remote"] and settings.startup["landmine-thrower-remote"].value then
	data:extend({{
		...
		action = "lua",
		technology_to_unlock = "landmine-thrower",
		unavailable_until_unlocked = true,
		style = "red",
